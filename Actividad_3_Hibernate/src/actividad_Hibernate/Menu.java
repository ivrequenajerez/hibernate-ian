...
public class Menu extends JFrame {
    ...
    public Menu(SessionFactory instancia) {
        ...
        btnBorrarCita.addActionListener(e -> {
            if (instancia != null) {
                ...
                int idCitaBorrar = Integer
                        .parseInt(JOptionPane.showInputDialog("Ingrese el ID de la cita a borrar:"));
     ...
     // ...
        ...
        btnCrearCita.addActionListener(e -> {
            if (instancia != null) {
                ...
                if (pacienteConsultado != null) {
                    ...
                    String fechaCitaString = JOptionPane.showInputDialog("Ingrese la fecha de la cita (formato: YYYY-MM-DD):");
        ...
        btnConsultarEspecialidad.addActionListener(e -> {
            if (instancia != null) {
                ...
                int idEspecialidadConsultar = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el ID de la especialidad a consultar:"));
        ...
        btnBorrarEspecialidad.addActionListener(e -> {
            if (instancia != null) {
                try {
                    ...
                    int idEspecialidadBorrar = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el ID de la especialidad a borrar:"));
        ...
        try (Session session = sessionFactory.openSession()) {
            ...
            if (paciente != null) {
                ...
                Paciente pacienteOriginal = new Paciente(paciente.getNombre(), paciente.getApellidos(),
                        paciente.getDirección(), paciente.getTeléfono(),
    ...
    private static Paciente consultarUnPaciente(SessionFactory sessionFactory, int idPaciente) {
        ...
        try (Session session = sessionFactory.openSession()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al consultar el paciente. Error: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
        return paciente;
    }
    ...
    private static void actualizarEspecialidad(SessionFactory sessionFactory, int idEspecialidad) {
        try (Session session = sessionFactory.openSession()) {
            ...
            if (especialidadActual != null) {
                JOptionPane.showMessageDialog(null, "Información actual de la especialidad:\n" + especialidadActual.toString());
                ...
                JOptionPane.showMessageDialog(null, "No se encontró una especialidad con el ID proporcionado.",
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
    ...
    private static void borrarEspecialidad(SessionFactory sessionFactory, int idEspecialidad) {
        try (Session session = sessionFactory.openSession()) {
            ...
            if (especialidad != null) {
                ...
                Especialidad especialidadOriginal = new Especialidad(especialidad.getTipo(), especialidad.getDescripcion());

                // Confirmar la eliminación
                int confirmacion = JOptionPane.showConfirmDialog(null, "¿Está seguro de que desea borrar la especialidad?",
    ...
    private static void consultarEspecialidad(SessionFactory sessionFactory, int idEspecialidad) {
        try (Session session = sessionFactory.openSession()) {
            ...
            if (especialidadConsultada != null) {
                ...
                JOptionPane.showMessageDialog(null, "Información de la especialidad:\n" + especialidadConsultada.toString());
            } else {
                JOptionPane.showMessageDialog(null, "No se encontró una especialidad con el ID proporcionado.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error al consultar la especialidad.", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
